...
from bird_identification.detection.detector import get_object_detector, detect_objects
from bird_identification.classification.classifier import get_image_classifier, classify_images
