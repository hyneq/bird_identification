...
class FileDetectionClassificationExtractor(
    FileExtractor[IPredictionResultWithClassesAndBoundingBoxes]
):
    def get_path(
        self, extracted_name: str, result: IPredictionResultWithClassesAndBoundingBoxes
    ) -> str:
