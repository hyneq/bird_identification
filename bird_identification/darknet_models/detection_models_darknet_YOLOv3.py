...
from .prediction import (
    DarknetPredictionModelWithClasses,
    DarknetPredictionModelWithClassesConfig,
)
...
class DarknetYOLOv3DetectionModel(
    DarknetPredictionModelWithClasses[YOLOv3DetectionModelOutput], YOLOv3DetectionModel
):
    def get_output(
...
class DarknetYOLOv3DetectionModelConfig(
    DarknetPredictionModelWithClassesConfig,
    YOLOv3DetectionModelConfig,
...
DARKNET_YOLOV3_DETECTION_MODEL_FACTORY = DetectionModelFactory[
