...
class IPathOutStreamFactory(
    IPathStreamFactory[OutStreamT], IOutStreamFactory[OutStreamT]
):
    pass
...
class IVideoInStreamFactory(IVideoStreamFactory, IInStreamFactory[VideoInStreamT]):
    @abstractmethod
    def __call__(
        self, fps: Optional[float] = None, size: Optional[Size] = None, *args, **kwargs
    ) -> VideoInStreamT:
        pass
...
class IPathVideoInStreamFactory(
    IPathVideoStreamFactory[VideoInStreamT], IVideoInStreamFactory[VideoInStreamT]
):
    pass


class IPathVideoOutStreamFactory(
    IPathVideoStreamFactory[VideoOutStreamT], IVideoOutStreamFactory[VideoOutStreamT]
):
    @abstractmethod
    def __call__(
        self, path: str, fps: float, size: Size, *args, **kwargs
    ) -> VideoOutStreamT:
        pass
...
@dataclass(frozen=True)
class AVideoStreamPairFactory(
    AStreamPairFactory[VideoInStreamT, VideoOutStreamT],
    IVideoStreamPairFactory[VideoInStreamT, VideoOutStreamT],
):
    ...
    def __call__(
        ...
        **__
        ...
        out_stream = self.stream_out_factory(
            *out_args, fps=in_stream.fps, size=in_stream.size, **out_kwargs
        )
...
@dataclass(frozen=True)
class MultiPathVideoStreamPairFactory(
    AVideoStreamPairFactory[IVideoInStream, IVideoOutStream],
    IPathStreamPairFactory[IVideoInStream, IVideoOutStream],
):
    ...
    def __call__(
        ...
        **__
        ...
        return super().__call__(
            ...
            size=size,
            in_args=in_args,
            in_kwargs={"factory": in_type, "path": in_path, **in_kwargs},
            out_args=out_args,
            out_kwargs={"factory": out_type, "path": out_path, **out_kwargs},
        )
