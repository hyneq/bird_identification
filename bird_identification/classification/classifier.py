...
class ClassificationProcessor(
    PredictionProcessorWithClasses[ClassificationModelOutput, ClassificationResult]
):
    __slots__: tuple

    def get_results(self, classes: list, scores: Scores) -> ClassificationResult:
        return ClassificationResult(
            self.class_names.get_names(classes), list(scores[classes])
        )
...
class ClassificationProcessorFactory(
    PredictionProcessorWithClassesFactory[
...
class ImageClassifier(
    PredictorWithClasses[
        PredictionInputT_cls, Image, ClassificationModelOutput, ClassificationResult
    ]
):
    __slots__: tuple
